...
```{ojs}
palette = ["#198737", "#FF8732", "#D62300", "#FFAA00", "#502314", "#F5EBDC"]
```
...
```{ojs}
// Define shape lookup by category (defaults) and activity (overrides)
// Lookup priority: activity+gender > category+gender > gender fallback
